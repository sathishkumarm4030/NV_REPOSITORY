...
Library           Collections
Library           String
Variables         DUAL_CPE_DUAL_INTERNET_SOLUTION_TEST_TOPOLOGY.py
...
SPIRENT_STARTUP
    ...
    ${device2}    spirent1.Create Device    port=1    vlanid=${CPE3['lan'][1]['vlan']}    intf_ip_addr=${CPE3['lan'][1]['second_host']}    gateway_ip_addr=${CPE3['lan'][1]['first_host']}
