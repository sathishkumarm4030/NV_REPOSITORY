...
def DO_config_in_VD_For_CPEs():
    ...
    VD1.vdnc = VD1.login()
    # VD1.vdnc = "1234"
    VD1.generic_config_function(nc=VD1.vdnc, csv_file=csv_file, template_file="ipsec_ike_transform_device_config.j2", config_for="ipsec_ike_transform", type="device_check", org_name=org_name)
    VD1.close(VD1.vdnc)
