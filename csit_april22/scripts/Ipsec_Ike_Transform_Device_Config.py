...
def DO_config_in_VD_For_CPEs():
    ...
    # csv_file = raw_input("Enter WC2 devices csv file name:\n")
    # org_name = "IPC00190"
    VD1.vdnc = VD1.login()
    # VD1.vdnc = "1234"
    VD1.snapshot_description = "PRE-WC2-IPSEC-CHANGE"
    csv_file = "WC2_DEVICES.csv"
    VD1.generic_config_function(nc=VD1.vdnc, csv_file=csv_file, template_file="ipsec_ike_transform_device_config.j2", config_for="ipsec_ike_transform", type="device", org_name=org_name)
    VD1.snapshot_description = "PRE-WC1-IPSEC-CHANGE"
